    ...
    <div className="px-5 md:px-20 lg:px-32 bg-[#EDEFF7]">
      <div className="container mx-auto pb-[90px] md:pb-20 flex flex-col md:flex-row md:justify-between">
        <div className=" md:max-w-[511px] pt-[42px] md:pb-0 md:pt-[117px]">
          ...
          This quiz can help determine whether you have the symptoms of low testosterone and get recommendations based on your results.
          </p>
          ...
          <div className="mt-[30px] ">
            <CustomButton title="Take the quiz" href="/tools/low-testosterone-assessment" />
          </div>
        </div>
