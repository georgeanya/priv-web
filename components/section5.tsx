...
const Section5 = () => {
  return (
    <div>
      <div className="md:py-[130px] md:px-32 ">
        <p className="md:text-[18px] md:leading-[21px] md:mb-4">
          CAN I TRUST PRIV?
        </p>
        <p className="text-[#5355AC] text-[38px] leading-[50px] md:max-w-[750px] font-medium">
