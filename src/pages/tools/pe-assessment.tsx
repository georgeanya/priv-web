    ...
    switch (riskLevel) {
      case "normal":
        return {
          ...
          description: "Based on your answers, it seems you do not have premature ejaculation or experience only occasional issues. If you feel concerned or notice future changes, it's good to consult a doctor, but there's no immediate cause for concern. Continue maintaining a healthy lifestyle, managing stress, and communicating openly with your partner."
        };
      case "mild":
        return {
          title: "Mild Premature Ejaculation",
          description: "You may experience mild symptoms of premature ejaculation, especially in stressful or highly stimulating situations. It might be helpful to practice relaxation techniques, communication with your partner, and focus on improving self-control. If the issue persists, consider seeking advice from a doctor."
        };
      case "moderate":
        return {
          title: "Moderate Premature Ejaculation",
          description: "You may be experiencing noticeable difficulty with premature ejaculation. Stress, anxiety, or other factors may be contributing to the issue. It's a good idea to speak with a doctor or therapist who can help you explore treatment options like behavioral therapy, medications, or lifestyle changes."
        };
      case "severe":
        return {
          title: "Severe Premature Ejaculation",
          description: "You are showing significant symptoms of premature ejaculation, which may be affecting your emotional well-being and your relationship. Immediate consultation with a doctor is recommended for a full assessment and personalized treatment options, which may include therapy, medication, or exercises designed to help improve control."
        };
      default:
        return {
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          content="https://privhealth.co/tools/pe-assessment"
          property="og:url"
        />
        <meta
